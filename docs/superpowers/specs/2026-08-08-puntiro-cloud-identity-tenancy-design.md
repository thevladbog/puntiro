...
Статус: согласованный и реализованный дизайн этапа 1; автоматическая приёмка записана, а Timeweb и другие deployment gates остаются отдельными и пока not run.
